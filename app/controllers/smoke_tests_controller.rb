class SmokeTestsController < ApplicationController
  ...
  # GET /smoke_tests.xml
  def index
    @smoke_tests = SmokeTest.find(:all, :include => [:nova_package_builder, :glance_package_builder, :keystone_package_builder, :swift_package_builder, :cinder_package_builder])
    ...
    if params[:table_only] then
      ...
      respond_to do |format|
        ...
        format.json  { render :json => @smoke_tests, :include => [:nova_package_builder, :glance_package_builder, :keystone_package_builder, :swift_package_builder, :cinder_package_builder] }
        format.xml  { render :xml => @smoke_tests, :include => [:nova_package_builder, :glance_package_builder, :keystone_package_builder, :swift_package_builder, :cinder_package_builder] }
      end
    end
  end
  ...
  def show
    @smoke_test = SmokeTest.find(params[:id], :include => [:nova_package_builder, :glance_package_builder, :keystone_package_builder, :swift_package_builder, :cinder_package_builder])

    respond_to do |format|
      format.html # show.html.erb
      format.json  { render :json => @smoke_test, :include => [:nova_package_builder, :glance_package_builder, :keystone_package_builder, :swift_package_builder, :cinder_package_builder] }
      format.xml  { render :xml => @smoke_test, :include => [:nova_package_builder, :glance_package_builder, :keystone_package_builder, :swift_package_builder, :cinder_package_builder] }
    end
  end
